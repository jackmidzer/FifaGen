...
public class LoginActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        registerTv = findViewById(R.id.registerId);
        recoverTv = findViewById(R.id.recoverId);
        ...
        //handle recover password textview click
    ...
    private void beginRecovery(String email) {
        //show progress dialog and start logging in
    ...
    private void loginUser(String email, String password) {
        ...
        mAuth.signInWithEmailAndPassword(email, password).addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            // Sign in success, dismiss progress dialog and start login activity
                            progressDialog.dismiss();
